  ...
  return (
    <div className='flex flex-col  items-center mt-32 '>
        ...
        <h1 className='text-4xl sm:text-5xl text-center  mb-4" animate-bounce '>
          <span className='animate-spin text-red-950'>Hello !</span> Ayesha Iqbal Here
        </h1>
        < h2 className='text-3xl sm:text-4xl text-center mb-6'> <span className='animate-pulse text-red-950'>Full Stuck Developer</span></h2>
        <Image src="/image/ash_profile.jpg" className="rounded-full drop-shadow-[0_35px_35px_rgba(136,0,0,0.98)] transition-transform hover:scale-110 " alt="Ayesha Iqbal" width={200} height={200}/>
